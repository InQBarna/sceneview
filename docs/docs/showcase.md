...
a declarative API that developers already understand. SceneViewSwift (v3.6.2 alpha) brings
...
SceneViewSwift v3.6.2 (alpha) already supports iOS, macOS, and visionOS via RealityKit.
